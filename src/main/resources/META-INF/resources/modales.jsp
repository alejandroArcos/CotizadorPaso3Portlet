<portlet:resourceURL id="/paso3/rechazoCotizacion" var="txtRechazaCotizacionURL" />
<portlet:resourceURL id="/sendMailSuscriptorAgente" var="sendMailSuscriptorAgenteUrl" />
<portlet:resourceURL id="/sendMailAgenteSuscriptor" var="sendMailAgenteSuscriptorUrl" />
	...
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-12">
						El agente seleccionado para esta cotización debe actualizar su expediente de Agente por lo que no es posible emitir esta cotización.   Dudas o comentarios, favor de escribir a <a href="mailto:enterate@tokiomarine.com.mx">enterate@tokiomarine.com.mx</a>.
					</div>
				</div>
			</div>

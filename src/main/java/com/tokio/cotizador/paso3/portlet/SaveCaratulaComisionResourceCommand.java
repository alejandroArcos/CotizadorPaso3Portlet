...
@Component(immediate = true, property = { "javax.portlet.name=" + CotizadorPaso3PortletKeys.CotizadorPaso3,
...
//		String pantalla = CotizadorPaso3PortletKeys.CotizadorPaso3;
		...
		if (tipoCoti.toLowerCase().contains("familiar")) {
			pantalla = CotizadorPaso3PortletKeys.PANTALLA_FAMILIAR;
		} else {
			pantalla = CotizadorPaso3PortletKeys.PANTALLA_EMPRESARIAL;
		}
